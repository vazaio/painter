<template>
	<div>		
		<div id="scrollPagesBoxWrapper">
			<div>			
				<svg version="1.1" baseProfile="tiny" id="svg"
				...
				<path id="check" fill="none" stroke="#3B3B3B" stroke-width="1" stroke-dasharray="15152" stroke-dashoffset="15152" d="M524.8,513.47c-0.04,0.1-0.08,0.22-0.12,0.32c-26.22-25.23-48.44-67.3-49.18-68.7c0.04-6.29,0.02-25.99-1.84-35.47
					...
					<animate id="svgAnimateParams" attributeName="stroke-dashoffset" begin="svg.svgAnimate" 
						values="15152; 14500" dur="7.2s" repeatCount="1"  fill="freeze"  calcMode="linear"/>
					</path>
				</svg>
			</div>
			<div id="scrollPagesBox">
				<div id="scrollParent">
					<div class="scrollAblePage">
						<p class="scrollApearAnimationFrom">MALENA.ART</p>
						<p class="scrollApearAnimationFrom">ПОЗНАКОМИТЬCЯ СО МНОЙ</p>
						<p class="scrollApearAnimationFrom">&#8744;</p>
					</div>
					<div class="scrollDisablePage">
						<p class="scrollApearAnimationFrom">
							Pictorem
						</p>
						<p class="scrollApearAnimationFrom">
							Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quo deserunt rem magni enim exercitationem velit quam sunt mollitia accusamus maxime sapiente distinctio, vel porro unde ducimus minima explicabo autem a.Ducimus atque voluptatem excepturi expedita delectus harum, iusto odit quaerat ea dolorum, ut nulla nisi maiores voluptatibus, eos repudiandae voluptate? Quos, ipsam? Iusto sed laboriosam quae dolores exercitationem cupiditate fuga!
						</p>
						<p class="scrollApearAnimationFrom">
							Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat a est aut. Quae, repellat. Explicabo excepturi repellat itaque dignissimos maxime eum illum dolorem ullam eveniet impedit nobis, laboriosam asperiores esse?
						</p>
						<p class="scrollApearAnimationFrom">
							Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ea cum architecto, aliquid, vitae expedita accusamus natus asperiores eum numquam pariatur tempora rem quisquam dolorem nam? Sint eaque aliquam incidunt ipsam?
							Numquam aperiam, maiores voluptates accusamus ab tempore assumenda animi nemo laboriosam quas in, corporis quasi odio blanditiis recusandae quae eius perspiciatis, obcaecati aliquam magni accusantium? Voluptatem, excepturi repudiandae! Perspiciatis, veniam?
							Cumque dolorum totam, distinctio nesciunt recusandae unde quam provident possimus quidem quaerat dignissimos in. Sed quaerat amet corporis earum totam autem reiciendis eaque deleniti deserunt dolores, voluptate expedita impedit! At.
						</p>
						<img class="scrollApearAnimationFrom" src="../assets/port.jpg" alt="portrait">
					</div>
					<div class="scrollDisablePage">
						<a id="instBioLink" class="scrollApearAnimationFrom" href="https://www.instagram.com/malena___art/?hl=ru" target="_blank">
							Malena Portfolio
							<img src="../assets/instagrams.svg" alt="inst">
						</a>
						<img class="scrollApearAnimationFrom" src="../assets/a8kGOAoOcuc.jpg" alt="portfolio_inst">
						<img class="scrollApearAnimationFrom" src="../assets/ao1S_cBHTSA.jpg" alt="portfolio_inst">
						<img class="scrollApearAnimationFrom" src="../assets/eRw1B3Se2bg.jpg" alt="portfolio_inst">
						<p class="scrollApearAnimationFrom">
							Lorem, ipsum dolor sit amet consectetur adipisicing elit. Harum rem iure, minus reiciendis facilis minima saepe? Doloribus, accusamus incidunt molestiae quas est, saepe hic placeat, fugiat totam quisquam commodi odio.
						</p>
					</div>
					<div class="scrollDsisablePage">
						<p class="scrollApearAnimationFrom">
							<router-link :to="{name:'order'}">
								Создать набросок
								<img src="../assets/paint-brush.svg" alt="paint">
							</router-link>				
						</p>
						<p class="scrollApearAnimationFrom">
							<router-link :to="{name:'contacts'}">
								Связаться со мной
								<img src="../assets/phone-call.svg" alt="phone">
							</router-link>
						</p>
						<section class="scrollApearAnimationFrom" id="linkBio">
							<a href="#"><img src="../assets/facebook.svg" alt="facebook"></a>
							<a href="#"><img src="../assets/pinterest.svg" alt="pinterest"></a>
							<a href="#"><img src="../assets/tumblr.svg" alt="tumblr"></a>
							<a href="#"><img src="../assets/twitter.svg" alt="twitter"></a>
							<a href="#"><img src="../assets/whatsapp.svg" alt="whatsapp"></a>
							<a href="#"><img src="../assets/instagrams.svg" alt="instagram"></a>
							<a id="linkBioHidden"><img src="../assets/none.png" alt="null"></a>
						</section>
					</div>
				</div>
			</div>
...
export default {
	data() {
		return {
			...
			svgBox: {},
			svgAnimateParams: {},
			svgAnimateMarks: ['15152','14900','13000','0'],
			scrollMark:0,
			scrollTo:0,
			scrolled:0,
			animationNext:false,
			pageDown: new Event('pageDown'),
			pageUp: new Event('pageUp'),
			svgAnimate: new Event('svgAnimate')
			//page animation end-------------------------------------------------
		}
	},
	computed: {
	...
	methods: {
		//page animation---------------------------------------------------------
		clearScrollBar() {
			this.pageBox.removeEventListener('scroll', this.checkWay)
			this.pageBox.style.overflowY='hidden'
			this.scrollMark=this.pageBox.scrollTop
		},
		checkWay(e) {
			if(e.target===this.btnDown) {
				this.pageBox.scrollTop+=10
				this.btnDown.removeEventListener('click', this.checkWay)
			}
			else if(e.target===this.btnUp) {
				this.pageBox.scrollTop-=10
				this.btnUp.removeEventListener('click', this.checkWay)
			}
			if(this.pageBox.scrollTop>this.scrollMark+1 && this.pageBox.scrollTop<this.scrollMark-1) {
				return 
			}
			else if(this.pageBox.scrollTop < this.scrollMark-1) {
				this.clearScrollBar()
				this.scrollTo--
				this.animationNext=false
				this.pageBox.dispatchEvent(this.pageUp)
			}
			else if(this.pageBox.scrollTop > this.scrollMark+1) {
				//mobile browsers constraints-----------------------------
				if(this.scrollTo===3) {
					this.scrollStabilizer()
					return
				}
				//mobile browsers constraints end-----------------------------
				this.clearScrollBar()
				this.scrollTo++
				this.animationNext=true
				this.pageBox.dispatchEvent(this.pageDown)
			}
		},
		scrollStabilizer() {			
			if(this.pageBox.scrollTop>this.scrollMark || this.pageBox.scrollTop<this.scrollMark) {
				this.pageBox.scrollTop=this.pageBoxHeight*this.scrollTo
			}
		},
		classSwitcher(el,radio) {
			if (el.classList.contains('scrollAblePage')) {
				el.classList.remove('scrollAblePage')
				radio.classList.remove('scrollActiveRadio')
				el.classList.add('scrollDisablePage')
			} else {
				el.classList.remove('scrollDisablePage')
				el.classList.add('scrollAblePage')
				radio.classList.add('scrollActiveRadio')
			}
		},
		pageAnimate(e) {
			let upDown
			if(this.animationNext) upDown=-1
			else upDown=1
			this.classSwitcher(this.pageBoxDiv.children[this.scrollTo+upDown], this.radioDiv.children[this.scrollTo+upDown])
			this.classSwitcher(this.pageBoxDiv.children[this.scrollTo], this.radioDiv.children[this.scrollTo])
			this.scrolled=Math.floor((this.pageBoxHeight*this.scrollTo)-this.scrollMark)
			this.pageBoxDiv.style.transition='800ms cubic-bezier(1,.1,.23,.92)'
			this.pageBoxDiv.style.transform=`translateY(${-this.scrolled}px)`
			//svg animation logic-------------------------
			let animateParamsStr=`${this.svgAnimateMarks[this.scrollTo+upDown]}; ${this.svgAnimateMarks[this.scrollTo]}`
			this.svgAnimateParams.setAttribute('values', animateParamsStr)
			this.svgBox.dispatchEvent(this.svgAnimate)
			//svg animation logic end-------------------------
			//text appear animation---------------------------
			this.textAnimation(this.scrollTo)
			//text appear animation end-----------------------
			setTimeout(()=>{
				this.pageBoxDiv.style.transition='0s'
				this.pageBoxDiv.style.transform=`translateY(${0}px)`
				this.pageBox.scrollTop=this.pageBoxHeight*this.scrollTo
				this.scrollMark=this.pageBox.scrollTop
				this.pageBox.style.overflowY='scroll'
				this.pageBox.addEventListener('scroll', this.scrollStabilizer)
				this.btnUp.addEventListener('click', this.checkWay)
				this.btnDown.addEventListener('click', this.checkWay)
			},800)
			setTimeout(()=>{
				this.pageBox.addEventListener('scroll', this.checkWay)
				this.pageBox.removeEventListener('scroll', this.scrollStabilizer)
			},1800)
		},
		textAnimation(num) {
			let textAnimationParent=document.querySelector('#scrollParent').children[num]
			if (textAnimationParent.children[0].classList.contains('scrollApearAnimationFrom')) {
				for(let el of textAnimationParent.children) {
					el.classList.remove('scrollApearAnimationFrom')
					el.classList.add('scrollApearAnimationTo')
				}
			}
			else return
		}
	...
	mounted() {
		//page animation----------------------------------------------------------
		this.pageBox=document.querySelector('#scrollPagesBox')
		this.pageBoxHeight=this.pageBox.offsetHeight
		this.pageBoxDiv=this.pageBox.firstElementChild
		this.radioDiv=document.querySelector('#scrollRadio').children[1]
		this.btnUp=document.querySelector('#scrollRadio').children[0]
		this.btnDown=document.querySelector('#scrollRadio').children[2]
		this.pageBox.addEventListener('scroll', this.checkWay)
		this.pageBox.addEventListener('pageDown', this.pageAnimate)
		this.pageBox.addEventListener('pageUp', this.pageAnimate)
		this.btnUp.addEventListener('click', this.checkWay)
		this.btnDown.addEventListener('click', this.checkWay)
		this.svgBox=document.querySelector('#svg')
		this.svgAnimateParams=document.querySelector('#svgAnimateParams')
		//page animation end-----------------------------------------------------
		//text animation---------------------------------------------------------
...
<style scoped>
	...
	#scrollParent div:nth-child(1) {
		-webkit-transition: 2s;
		-o-transition: 2s;
		transition: 2s;
	}
	#scrollParent div:nth-child(1) p:nth-child(1) {
		position:relative;
		top:50%;
	...
	#scrollParent div:nth-child(1) p:nth-child(2) {
		position: relative;
		top:60%;
		text-align: center;
		font-size:26px;
	...
	#scrollParent div:nth-child(1) p:nth-child(3) {
		position: absolute;
		bottom: 0%;
		width:100%;
		text-align: center;
	...
	#scrollParent div:nth-child(2) {
		-webkit-transition: 2.1s;
		-o-transition: 2.1s;
		transition: 2.1s;
		position: relative;
	}
	#scrollParent div:nth-child(2) p:nth-child(1) {
		position: relative;
		width: 30%;
		top:10%;
		left:5%;
	...
	#scrollParent div:nth-child(2) p:nth-child(2) {
		display: block;
		width:40%;
		max-height: 30%;
		position: relative;
	...
	#scrollParent div:nth-child(2) p:nth-child(3) {
		display: block;
		width:30%;
		position: relative;
		top:20%;
	...
	#scrollParent div:nth-child(2) p:nth-child(4) {
		display: block;
		width:30%;
		max-height:60%;
		position: absolute;
	...
	#scrollParent div:nth-child(2) img:nth-child(5) {
		width:14%;
		position: absolute;
		bottom: 5%;
		left: 4%;
		-webkit-box-shadow: 2px 5px 4px rgba(0,0,0,0.6);
	...
	#scrollParent div:nth-child(3) {
		-webkit-transition: 2.2s;
		-o-transition: 2.2s;
		transition: 2.2s;
	}
	#scrollParent div:nth-child(3) a {
	...
	#scrollParent div:nth-child(3) a img {
		width: 40px;
		opacity: 0;
	...
	#scrollParent div:nth-child(3) a:hover > img {
		opacity: 1;
	...
	#scrollParent div:nth-child(3) img {
		width: 13%;
		-webkit-box-shadow: 1px 5px 4px rgba(0,0,0,0.3);
		        box-shadow: 1px 5px 4px rgba(0,0,0,0.3);	
	}
	#scrollParent div:nth-child(3) img:nth-child(2) {
		position: absolute;
		z-index: 6;
		top:4%;
		left:5%;
	...
	#scrollParent div:nth-child(3) img:nth-child(3) {
		position: absolute;
		top:50%;
		left:15%;
		-webkit-transition: inherit;
	...
	#scrollParent div:nth-child(3) img:nth-child(4) {
		position: absolute;
		top:60%;
		right: 22%;
		-webkit-transition: inherit;
	...
	#scrollParent div:nth-child(3) p {
		position: absolute;
		top:10%;
		left:22%;
		display: block;
	...
	#scrollParent div:nth-child(4) {
		-webkit-transition:2s;
		-o-transition:2s;
		transition:2s;
		position: relative;
	}
	#scrollParent div:nth-child(4) a {
		color:#3B3B3B;
		text-decoration: none;
	}
	#scrollParent div:nth-child(4) p:nth-child(1) {
		position: relative;
		display: block;
		width:40%;
		top:30%;
	...
	#scrollParent div:nth-child(4) p:nth-child(2) {
		position:relative;
		display: block;
		width:40%;
		top:60%;
	...
	#scrollParent div:nth-child(4) p:nth-child(1) a, #scrollParent div:nth-child(4) p:nth-child(2) a {
		display: -webkit-box;
		display: -ms-flexbox;
		display: flex;
		-webkit-box-orient: vertical;
	...
	#scrollParent div:nth-child(4) p:nth-child(1)  a  img{
		opacity: 0;
		-webkit-transform: scale(0.8);
		    -ms-transform: scale(0.8);
		        transform: scale(0.8);
	...
	#scrollParent div:nth-child(4) p:nth-child(2) a img  {
		opacity: 0;
		-webkit-transform: scale(0.8);
		    -ms-transform: scale(0.8);
		        transform: scale(0.8);
	...
	#scrollParent div:nth-child(4) p:nth-child(1):hover > a > img {
		opacity: 1;
		-webkit-transform: scale(1);
		    -ms-transform: scale(1);
		        transform: scale(1);
	}
	#scrollParent div:nth-child(4) p:nth-child(2):hover > a > img {
		opacity: 1;
		-webkit-transform: scale(1);
		    -ms-transform: scale(1);
		        transform: scale(1);
	...
	.scrollApearAnimationFrom {
		-webkit-transform: scale(0.85);
		    -ms-transform: scale(0.85);
		        transform: scale(0.85);
		opacity: 0;
	}
	.scrollApearAnimationTo {
		-webkit-transform: scale(1);
		    -ms-transform: scale(1);
		        transform: scale(1);
		opacity: 1;
